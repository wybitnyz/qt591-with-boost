...
&& yum install -y devtoolset-7-gcc maven devtoolset-7-gcc-c++ git rpm-build rpmdevtools libstdc++-devel make boost boost-devel libcurl libcurl-devel ncurses-devel systemd-devel libuuid-devel java-1.8.0-openjdk-devel mesa-libGL-devel lcov doxygen \
