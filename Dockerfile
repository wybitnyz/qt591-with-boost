...
&& yum install -y gcc gcc-c++ cmake maven git rpm-build rpmdevtools libstdc++-devel make boost boost-devel libcurl libcurl-devel systemd-devel libuuid-devel java-1.8.0-openjdk-devel mesa-libGL-devel graphviz openssl-libs ncurses-devel hivex-devel \
